...
function renderStorefront() {
  ...
  // Carrega os dados ou usa itens padrão
...
if (checkoutForm) {
  checkoutForm.addEventListener('submit', (e) => {
    ...
    const emailSubject = `Novo Pedido: ${prodName}`;
    const emailBody = `Olá! Tudo bem? Meu nome é ${clientName}.\n\nGostaria de prosseguir com a compra do produto:\n📦 Produto: ${prodName}\n💵 Valor: ${prodPrice}\n\nGostaria de Saber mais informações!`;
    const mailtoLink = `mailto:contatosph96@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
